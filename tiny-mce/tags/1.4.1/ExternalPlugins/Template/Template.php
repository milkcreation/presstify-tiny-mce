...
class Template extends AbstractExternalPlugin
{
    ...
    public function boot()
    {
        ...
        $this->app()->appAddAction('wp_ajax_tinymce_plugin_template', [$this, 'wp_ajax']);
    }
